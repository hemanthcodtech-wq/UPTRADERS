    ...
    <div className="bg-[#FAF9F6] min-h-screen font-sans text-gray-800">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="prose prose-sm md:prose-base prose-blue max-w-none text-gray-700 space-y-6">
          ...
          <p>
            Individuals between 13 and 17 years of age may use the website subject to our <Link to="/terms-of-service" className="text-brand-green underline font-semibold">Terms & Conditions</Link> and applicable law.
          </p>
          <p>
          ...
          <p>For example:</p>
          <blockquote className="border-l-4 border-brand-green/10 pl-4 py-2 italic text-gray-600 bg-gray-50 rounded-r">
          ...
          <ul className="list-none pl-0 space-y-2 font-medium">
            ...
            <li>Privacy Email: <a href="#" className="text-brand-green underline"></a></li>
          ...
          <p>This Privacy Policy does not replace the UP Traders <Link to="/terms-of-service" className="text-brand-green underline font-semibold">Terms & Conditions</Link>.</p>
        </div>
      </div>
      <Footer />
    </div>
