...
function ForgotPassword({ onBack, dark = false }) {
  ...
  const inputCls = dark
    ...
    : 'w-full bg-white border border-gray-200 shadow-inner rounded-xl px-4 pl-11 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-[#106935] focus:ring-4 focus:ring-[#106935]/10 focus:bg-white hover:border-gray-300 transition-all duration-300 shadow-sm';
  ...
  const btnCls = dark
    ...
    : 'w-full bg-gradient-to-r from-[#106935] to-[#15803d] text-white font-bold py-3.5 rounded-xl text-sm hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-60 disabled:hover:translate-y-0 shadow-md';
  const errCls = dark
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-gray-200 shadow-inner rounded-xl px-4 pl-11 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-[#106935] focus:ring-4 focus:ring-[#106935]/10 focus:bg-white hover:border-gray-300 transition-all duration-300 shadow-sm"
                  />
                </div>
              </div>
              ...
              {displayError && (
                ...
                <motion.button
                  ...
                  className="w-full bg-gradient-to-r from-[#106935] to-[#15803d] text-white font-bold py-3.5 rounded-xl text-sm hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-60 disabled:hover:translate-y-0 mt-4 shadow-md"
                >
            ...
            <p className="text-center text-sm text-gray-900/60 mt-4">
              ...
              <Link to="/signup" className="font-bold text-gray-900 hover:text-brand-green transition-colors">
                Create Account
              </Link>
            </p>
              </>
      ...
      <div className="lg:hidden h-screen w-full bg-gray-100 font-sans flex flex-col items-center justify-center overflow-hidden px-4 py-2">
        ...
        >
          <div className="flex flex-col items-center mb-6 mt-2">
            ...
            <h1 className="font-sans font-extrabold tracking-tight text-gray-900 text-sm">UP Traders</h1>
          </div>
        ...
        <p className="text-center text-xs text-gray-500 mt-4">
          Don't have an account?{' '}
          <Link to="/signup" className="text-brand-green font-bold hover:text-brand-green/80 transition-colors">
            Create Account
          </Link>
        </p>
