            ...
            <div>
              ...
              <div className="space-y-2">
                {items.map((item, idx) => {
                  ...
                  return (
                    <div key={idx} className="flex gap-3 items-start p-3 bg-[#FDF8F0] rounded-xl border border-brand-green/10">
                ...
                {[['name','Full Name'],['line1','Address Line 1'],['line2','Line 2 (optional)'],['city','City'],['state','State'],['pincode','ZIP']].map(([field, label]) => (
                  <div key={field} className={field === 'line1' ? 'col-span-2' : ''}>
                    ...
                    <input value={address[field] || ''} onChange={e => setAddress(a => ({ ...a, [field]: e.target.value }))}
                      className="w-full text-sm border border-brand-green/15 rounded-xl px-3 py-2 bg-[#FDF8F0] text-gray-900 focus:outline-none focus:border-brand-green/30" />
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  {isFullCancel && shippingDisplay > 0 && (
                    <label className="flex items-center justify-between p-3 bg-[#FDF8F0] rounded-xl border border-brand-green/10 cursor-pointer">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <select value={order.status} onChange={(e) => updateStatus(order.id, e.target.value)}
                        className="w-full px-3 py-2 rounded-xl bg-[#FDF8F0] border border-brand-green/10 text-gray-900 font-sans text-sm focus:outline-none">
