    ...
    <div className="bg-[#FAF9F6] min-h-screen font-sans text-gray-800">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="prose prose-sm md:prose-base prose-blue max-w-none text-gray-700 space-y-6">
          ...
          <p>Please review our <Link to="/shipping-policy" className="text-brand-green underline font-semibold">Shipping Policy</Link> and <Link to="/returns-policy" className="text-brand-green underline font-semibold">Return & Exchange Policy</Link> for more details.</p>
          ...
          <p>Please review our <Link to="/shipping-policy" className="text-brand-green underline font-semibold">Shipping Policy</Link> and <Link to="/returns-policy" className="text-brand-green underline font-semibold">Return & Exchange Policy</Link> for detailed information.</p>
          ...
          <p>Please review our <Link to="/privacy-policy" className="text-brand-green underline font-semibold">Privacy Policy</Link>.</p>
          ...
          <ul className="list-none pl-0 space-y-2 font-medium">
            ...
            <li>Email: <a href="#" className="text-brand-green underline"></a></li>
            <li>Website: <a href="https://upraders.com" target="_blank" rel="noopener noreferrer" className="text-brand-green underline">https://upraders.com</a></li>
