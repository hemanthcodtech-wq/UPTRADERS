...
function FaqItem({ faq }) {
  ...
  return (
    <div className={`border rounded-2xl overflow-hidden transition-all ${open ? 'border-brand-green/10' : 'border-brand-green/10'}`}>
      ...
      >
        <p className="px-5 py-4 text-sm text-gray-900/70 leading-relaxed border-t border-brand-green/10">{faq.a}</p>
      </motion.div>
    </div>
  );
}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5">
          {[
            ...
            <motion.div
              ...
              className="bg-white border border-brand-green/10 rounded-2xl p-4 md:p-5 text-center shadow-sm"
            >
              <p className={`text-lg md:text-xl font-serif font-bold ${i < 2 ? 'text-red-500' : 'text-brand-green'}`}>{s.value}</p>
      ...
      <div className="px-4 md:px-24 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  className="bg-white border border-brand-green/10 rounded-2xl p-6 shadow-sm"
                >
            ...
            >
              <div className="flex items-center gap-4 mb-5">
                <div className="w-12 h-12 rounded-full bg-brand-green text-white/20 flex items-center justify-center shrink-0">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-white border border-brand-green/10 rounded-2xl p-6 md:p-8 shadow-sm flex gap-5"
            >
              ...
              <div className="space-y-4">
                {claimSteps.map((step, i) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: i * 0.08 }}
                    className="bg-white border border-brand-green/10 rounded-2xl p-5 md:p-6 flex gap-5 shadow-sm"
                  >
                    <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center shrink-0">
                      <span className="text-brand-green font-bold text-sm">{step.num}</span>
                    </div>
                    <div>
          ...
          <div className="space-y-5 lg:sticky lg:top-24">
            ...
            >
              <div className="w-12 h-12 rounded-full bg-brand-green text-white/10 flex items-center justify-center mx-auto mb-4">
              ...
              <a href="https://wa.me/19404656563" target="_blank" rel="noopener noreferrer"
                className="block w-full bg-brand-green text-white text-gray-900 font-bold py-3 rounded-xl text-sm hover:bg-brand-green text-white/80 transition-all">
                Chat on WhatsApp
              </a>
              <a href="#"
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.1 }}
              className="bg-white border border-brand-green/10 rounded-2xl p-6 space-y-4"
            >
            ...
            <motion.div
              ...
              className="bg-brand-beige border border-brand-green/10 rounded-2xl p-6"
            >
            ...
            >
              ...
              <a href="/shipping-policy" className="flex items-center justify-between py-3 border-b border-brand-green/10 text-sm text-gray-900/70 hover:text-brand-green transition-colors">
                Shipping Policy <span>→</span>
              </a>
              <a href="/contact#faq-section" className="flex items-center justify-between pt-3 text-sm text-gray-900/70 hover:text-brand-green transition-colors">
                All FAQs <span>→</span>
              </a>
            </motion.div>
          </div>
