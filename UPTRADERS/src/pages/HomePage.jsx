  ...
  return (
    <div className="animate-section md:px-8 mb-4 md:mb-10">
      {/* <div
        ...
        style={{
          background: 'linear-gradient(135deg, #106935 0%, #B81633 60%, #106935 100%)',
...
<span className="text-[#F29D38] font-semibold">Delivered Daily</span>
                ...
                <Link to="/category/all" className="bg-[#106935] text-white text-[11px] md:text-xs font-bold px-6 py-3 md:px-8 md:py-3.5 rounded-xl w-fit shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all hover:bg-[#0a4722] tracking-wider uppercase">
                  SHOP NOW
                </Link>
              </div>
            </div>
