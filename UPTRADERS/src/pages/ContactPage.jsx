  ...
  return (
    <div className="bg-brand-beige min-h-screen pb-20 md:pb-12 font-sans">
      ...
      <div className="px-4 md:px-24 pt-12 md:pt-16 pb-10 md:pb-14">
        ...
        >
          <h4 className="text-brand-green font-bold tracking-widest uppercase text-xs md:text-sm mb-3">Customer Support</h4>
          ...
          <div className="w-20 h-1.5 bg-brand-green text-white rounded-full mb-6"></div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm flex-grow flex flex-col justify-between">
              <div>
                ...
                <div className="flex items-center gap-4">
                  <a href="https://www.instagram.com/uptraders?igsh=c2llNGRzM2RpbHZ3&utm_source=qr" target="_blank" rel="noopener noreferrer"
                  ...
                  <a href="https://youtube.com/@UP Traders7471?si=3sOLJa_Rvzxhgx7V" target="_blank" rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full bg-white border border-brand-green/20 flex items-center justify-center text-brand-green shadow-sm hover:scale-105 hover:shadow-md transition-all">
      ...
      <div id="faq-section" className="bg-white py-16">
        <div className="px-4 md:px-24">
          <div className="text-center mb-12">
            ...
            <div className="w-16 h-1 bg-brand-green text-white mx-auto rounded-full"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <motion.div
                ...
                className="bg-brand-beige border border-brand-green/10 rounded-2xl p-6 hover:shadow-md transition-shadow"
              >
                <div className="flex items-start gap-3">
                  <div className="w-7 h-7 rounded-full bg-white flex items-center justify-center shrink-0 mt-0.5">
                    <span className="text-brand-green text-xs font-bold">Q</span>
                  </div>
                  <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <motion.div
              ...
              className="bg-white border border-brand-green/10 rounded-2xl p-6 text-center shadow-sm hover:shadow-lg transition-shadow"
            >
              <p className="text-3xl md:text-4xl font-serif font-bold text-brand-green mb-2">
