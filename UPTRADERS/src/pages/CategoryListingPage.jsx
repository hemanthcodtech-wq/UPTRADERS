          ...
          <>
            <button
              ...
              className={`min-h-[38px] shrink-0 rounded-full border px-5 py-1.5 text-sm font-semibold transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-brand-gold motion-reduce:transition-none ${
                !modelQuery
                  ? 'border-[#106935] bg-[#106935] text-white'
          ...
          <>
            ...
            >
              <div className={`w-[60px] h-[60px] rounded-full flex items-center justify-center border-2 overflow-hidden transition-all ${
                categoryId === 'all' ? 'border-[#106935] bg-red-50' : 'border-transparent bg-white shadow-sm group-hover:border-gray-200'
              }`}>
                <LayoutGrid className={`w-6 h-6 ${categoryId === 'all' ? 'text-[#106935]' : 'text-gray-400'}`} />
              </div>
              <span className={`text-[10px] font-semibold text-center w-[72px] leading-tight ${categoryId === 'all' ? 'text-[#106935]' : 'text-gray-600'}`}>
                All Categories
              </span>
            </button>
            {categories.map((category) => (
              ...
              >
                <div className={`w-[60px] h-[60px] rounded-full flex items-center justify-center border-2 overflow-hidden bg-white transition-all ${
                  categoryId === String(category.id) ? 'border-[#106935] p-[2px]' : 'border-transparent shadow-sm group-hover:border-gray-200'
                }`}>
                  <img 
                ...
                <span className={`text-[10px] font-semibold text-center w-[72px] leading-tight line-clamp-2 ${categoryId === String(category.id) ? 'text-[#106935]' : 'text-gray-600'}`}>
                  {category.name}
                </span>
              </button>
            ))}
