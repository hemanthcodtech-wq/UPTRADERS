...
const sections = [
  ...
  {
    id: 'packaging',
    icon: <Package className="w-6 h-6 text-brand-green" />,
...
function AccordionItem({ section, isOpen, toggle }) {
  return (
    <div className={`border rounded-2xl overflow-hidden transition-all duration-300 ${isOpen ? 'border-brand-green/10 shadow-md' : 'border-brand-green/10 shadow-sm'}`}>
      <button
        onClick={toggle}
      ...
      >
        <ul className="px-5 md:px-6 py-5 space-y-3 border-t border-brand-green/10">
      ...
      <div className="px-4 md:px-24 -mt-1">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5 py-8">
          {[
            ...
            >
              <p className="text-xl md:text-2xl font-serif font-bold text-brand-green">{s.value}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-5 lg:sticky lg:top-24">
            ...
            >
              ...
              <a href="/returns-policy" className="flex items-center justify-between py-3 border-b border-brand-green/10 text-sm text-gray-900/70 hover:text-brand-green transition-colors">
