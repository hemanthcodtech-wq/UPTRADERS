...
function DesktopFullHeader({ cartCount, wishlistCount, token, user, handleLogout, categories, offers, announcement, locationName, isLoadingLocation, fetchLocation }) {
  return (
    <>
      ...
      <header className={`fixed ${announcement && announcement.is_active && announcement.items?.some(i => i.text) ? 'top-[32px]' : 'top-0'} left-0 z-50 w-full bg-[#106935] px-4 md:px-12 lg:px-20 py-3 shadow-md border-b border-[#0a4722] hidden md:block transition-all`}>
        <div className="w-full mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3 hover:opacity-95 transition-opacity">
              ...
              <div className="flex flex-col text-left mt-1">
                <Link to="/">
                  <span className="font-serif font-bold text-xl leading-none tracking-[0.1em] text-white whitespace-nowrap block">UP Traders</span>
                </Link>
          ...
          <div className="flex items-center gap-3">
            <Link to="/wishlist" className="relative p-1 cursor-pointer hover:-translate-y-0.5 transition-transform">
              ...
              {wishlistCount > 0 && (
                <span className="absolute top-0 right-0 bg-[#F29D38] text-white text-[10px] font-bold w-4 h-4 flex items-center justify-center rounded-full border border-[#106935]">
                  {wishlistCount}
                </span>
              )}
            </Link>
      ...
      {mobileMenuOpen && (
        <>
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                <div className="h-12 w-auto bg-white rounded-xl p-1.5 shadow-sm border border-brand-green/10 flex items-center justify-center">
  ...
  return (
    <>
      ...
      <div className="md:hidden">
        ...
        <header className={`fixed ${announcement && announcement.is_active && announcement.items?.some(i => i.text) && variant !== 'home' ? 'top-[27px]' : 'top-0'} left-0 z-50 w-full ${variant === 'home' ? 'bg-[#106935] pt-2 pb-4 px-4 h-auto' : 'bg-[#106935] backdrop-blur-md px-4 py-2 shadow-lg border-b border-[#0a4722] h-[76px] transition-all'}`}>
          {variant === 'home' ? (
              ...
              <div className="flex items-center justify-between w-full mb-1">
                <div className="flex items-center gap-2">
                  ...
                  <Link to="/" className="flex flex-col text-left">
                    <span className="font-serif font-bold text-2xl leading-none text-white truncate pr-2">UP Traders</span>
                  </Link>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <Link to="/cart" className="relative bg-[#F29D38] rounded-full p-2.5 text-white flex-shrink-0 cursor-pointer hover:scale-105 transition-transform shadow-sm">
                    ...
                    {cartCount > 0 && (
                      <span className="absolute -top-1 -right-1 bg-white text-[#F29D38] text-[9px] font-bold w-4 h-4 flex items-center justify-center rounded-full border-2 border-[#106935]">
                        {cartCount}
                      </span>
                    )}
                  </Link>
            ...
            <div className="w-full h-full flex items-center justify-between relative">
              ...
              <div className="flex items-center gap-2">
                ...
                <Link to="/" className="flex flex-col text-left">
                  <span className="font-serif font-bold text-xl leading-none text-white truncate pr-2">UP Traders</span>
                </Link>
              </div>
