      ...
      <div role="link" tabIndex={0} aria-label={`View ${productName}`} onClick={handleCardClick} onKeyDown={handleCardKeyDown}
        ...
        {isSelectedOutOfStock ? (
          ...
          <button type="button" aria-label={`Add ${productName} to cart`} title="Add to cart" onClick={handleAddToCart}
            className="absolute bottom-3 right-3 flex h-9 px-4 items-center justify-center gap-1.5 rounded-full bg-gradient-to-r from-[#106935] to-[#15803d] text-[13px] font-semibold text-white shadow-md transition-all hover:scale-105 hover:shadow-lg active:scale-95">
        ...
        <div className="mt-2 flex flex-wrap items-baseline gap-1.5">
          ...
          {(activeOffer || originalPrice > displayPrice) && (
            <>
              ...
              {activeOffer && <span className="text-[9px] font-bold text-[#106935]">{parseFloat(activeOffer.discount_percentage)}% OFF</span>}
            </>
          )}
        </div>
        ...
        <div className="mt-auto pt-3">
          {isSelectedOutOfStock ? (
            ...
            <button type="button" id={`add-to-cart-${product.id}`}
              ...
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#106935] to-[#15803d] py-2.5 text-sm font-semibold text-white shadow-md transition-all hover:scale-[1.02] hover:shadow-lg active:scale-95">
