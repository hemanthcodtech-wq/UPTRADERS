  ...
  if (layout === 'list') {
    return (
      ...
      >
        ...
        {isOutOfStock ? (
          <span className="absolute bottom-4 right-4 rounded-full border border-brand-green/20 bg-red-50 px-3 py-1.5 text-xs font-semibold text-brand-green">
            Out of stock
          </span>
        ) : (
          <button
    ...
    >
      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="mt-auto flex flex-col gap-3 pt-3">
            ...
            <div className="flex flex-wrap items-baseline gap-1.5 mt-0.5">
              ...
              {(activeOffer || originalPrice > displayPrice) && (
                <>
                  ...
                  {activeOffer && (
                    <span className="text-[9px] font-bold text-[#106935]">{parseFloat(activeOffer.discount_percentage)}% OFF</span>
                  )}
                </>
              )}
            </div>
          ...
          {isOutOfStock ? (
            <span className="w-full text-center rounded-xl border border-brand-green/20 bg-red-50 px-3 py-2 text-[12px] font-semibold text-brand-green">
              Out of stock
            </span>
          ) : (
            <button
              ...
              title="Add to cart"
              onClick={handleAddToCart}
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#106935] to-[#15803d] py-2 text-sm font-semibold text-white shadow-md transition-all hover:scale-[1.02] hover:shadow-lg active:scale-95"
            >
              <ShoppingCart className="h-4 w-4" />
