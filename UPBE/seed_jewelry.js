  ...
  try {
    ...
    for (const cat of categories) {
      for (let i = 1; i <= 10; i++) {
        ...
        const description = `This is a beautifully crafted ${name}, perfect for adding a touch of elegance to your attire. Handcrafted by master artisans with precision and care, this piece is a testament to the luxurious heritage of UP Traders.`;
